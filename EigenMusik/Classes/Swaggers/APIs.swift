...
public class EigenMusikAPI {
    public static var basePath = "https://api.eigenmusik.com/"
...
public class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:AnyObject]?, isBody: Bool) {
        ...
        addHeaders(EigenMusikAPI.customHeaders)
    }
    ...
    public func addCredential() -> Self {
        self.credential = EigenMusikAPI.credential
        return self
    }
}
